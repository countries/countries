...
The datasets from this gem are also available in YAML and JSON formats as git submodules in https://github.com/countries/countries-data-yaml and https://github.com/countries/countries-data-json
